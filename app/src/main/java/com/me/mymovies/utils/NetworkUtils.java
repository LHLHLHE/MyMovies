...
public class NetworkUtils {
    ...
    public static final String BASE_VIDEOS_URL = "https://api.themoviedb.org/3/movie/%s/videos";
    public static final String BASE_REVIEWS_URL = "https://api.themoviedb.org/3/movie/%s/reviews";
    ...
    public static JSONObject getJSON(int sortBy, int page, String lang) {
